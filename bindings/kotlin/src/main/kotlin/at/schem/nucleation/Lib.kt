...
object DW {
    ...
    val lib: DiplomatWriteLib = Native.load("nucleation", libClass)
...
internal class DiplomatJVMRuntime {
    companion object {
        ...
        val lib: DiplomatJVMRuntimeLib = Native.load("nucleation", libClass, Collections.singletonMap(Library.OPTION_ALLOW_OBJECTS, true))
...
internal object PrimitiveArrayTools {
    ...
    val lib: DiplomatAllocateLib = Native.load("nucleation", libClass)
...
internal class ResultBlockPosNativeIntUnion: Union() {
    @JvmField
    internal var ok: BlockPosNative = BlockPosNative()
    @JvmField
    internal var err: Int = 0
}

class ResultBlockPosNativeInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultBlockPosNativeIntUnion = ResultBlockPosNativeIntUnion()
    ...
    internal fun getNativeOk(): BlockPosNative? {
        if (isOk == 1.toByte()) {
            return union.getTypedValue(BlockPosNative::class.java) as BlockPosNative
        }
        return null
    }
...
internal class ResultDimensionsNativeIntUnion: Union() {
    @JvmField
    internal var ok: DimensionsNative = DimensionsNative()
    @JvmField
    internal var err: Int = 0
}

class ResultDimensionsNativeInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultDimensionsNativeIntUnion = ResultDimensionsNativeIntUnion()
    ...
    internal fun getNativeOk(): DimensionsNative? {
        if (isOk == 1.toByte()) {
            return union.getTypedValue(DimensionsNative::class.java) as DimensionsNative
        }
        return null
    }
    internal fun getNativeErr(): Int? {
...
class ResultFFIUint32Int: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultFFIUint32IntUnion = ResultFFIUint32IntUnion()
    ...
    internal fun getNativeOk(): FFIUint32? {
        if (isOk == 1.toByte()) {
            return union.getTypedValue(FFIUint32::class.java) as FFIUint32
        }
        return null
    }
    internal fun getNativeErr(): Int? {
...
class ResultFloatInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultFloatIntUnion = ResultFloatIntUnion()
    ...
    internal fun getNativeOk(): Float? {
        if (isOk == 1.toByte()) {
            return union.getTypedValue(Float::class.java) as Float
        }
        return null
    }
    internal fun getNativeErr(): Int? {
...
internal class ResultIntIntUnion: Union() {
    @JvmField
...
class ResultIntInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultIntIntUnion = ResultIntIntUnion()
...
internal class ResultItemScaleNativeIntUnion: Union() {
    @JvmField
    internal var ok: ItemScaleNative = ItemScaleNative()
    @JvmField
    internal var err: Int = 0
}

class ResultItemScaleNativeInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultItemScaleNativeIntUnion = ResultItemScaleNativeIntUnion()
    ...
    internal fun getNativeOk(): ItemScaleNative? {
        if (isOk == 1.toByte()) {
            return union.getTypedValue(ItemScaleNative::class.java) as ItemScaleNative
        }
        return null
    }
    internal fun getNativeErr(): Int? {
...
internal class ResultRegionBoundsNativeIntUnion: Union() {
    @JvmField
    internal var ok: RegionBoundsNative = RegionBoundsNative()
    @JvmField
    internal var err: Int = 0
}

class ResultRegionBoundsNativeInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultRegionBoundsNativeIntUnion = ResultRegionBoundsNativeIntUnion()
...
class ResultTextureInfoNativeInt: Structure(), Structure.ByValue  {
    @JvmField
    internal var union: ResultTextureInfoNativeIntUnion = ResultTextureInfoNativeIntUnion()
    ...
    internal fun getNativeOk(): TextureInfoNative? {
        if (isOk == 1.toByte()) {
            return union.getTypedValue(TextureInfoNative::class.java) as TextureInfoNative
        }
        return null
    }
    internal fun getNativeErr(): Int? {
