...
export class TickSimulation {
     ...
     * ceiling and not.
     */
    readProbes(positionsJson) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();

        const positionsJsonSlice = functionCleanupArena.alloc(diplomatRuntime.DiplomatBuf.sliceWrapper(wasm, diplomatRuntime.DiplomatBuf.str8(wasm, positionsJson)));
        const diplomatReceive = new diplomatRuntime.DiplomatReceiveBuf(wasm, 5, 4, true);

        const write = new diplomatRuntime.DiplomatWriteBuf(wasm);


        const result = wasm.TickSimulation_read_probes(diplomatReceive.buffer, this.ffiValue, positionsJsonSlice.ptr, write.buffer);
     ...
     */
    conductionTrace(x, y, z) {
        const write = new diplomatRuntime.DiplomatWriteBuf(wasm);

    wasm.TickSimulation_conduction_trace(this.ffiValue, x, y, z, write.buffer);
    ...
    bakeTo(schematic) {
        ...
        const result = wasm.TickSimulation_bake_to(this.ffiValue, schematic.ffiValue);
