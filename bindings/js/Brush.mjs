...
export class Brush {
     ...
     */
    static fieldSdf(field, stops, colors, lo, hi, space) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
        ...
        const result = wasm.Brush_field_sdf(diplomatReceive.buffer, field.ffiValue, stopsSlice.ptr, colorsSlice.ptr, lo, hi, space.ffiValue);
     ...
     */
    static field3(field, stops, colors, lo, hi, space) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
        ...
        const result = wasm.Brush_field3(diplomatReceive.buffer, field.ffiValue, stopsSlice.ptr, colorsSlice.ptr, lo, hi, space.ffiValue);
