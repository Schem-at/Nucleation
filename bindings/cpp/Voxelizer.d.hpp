...
public:
   ...
   */
  inline static diplomat::result<std::unique_ptr<Shape>, NucleationError> shape_from_glb(diplomat::span<const uint8_t> data, float target_size);
   ...
   * `target_size`.
   */
  inline static diplomat::result<std::unique_ptr<Shape>, NucleationError> shape_from_obj(std::string_view text, float target_size);
   ...
   * `target_size`.
   */
  inline static diplomat::result<std::unique_ptr<Schematic>, NucleationError> schematic_from_glb_textured(diplomat::span<const uint8_t> data, float target_size, const Palette& palette, std::string_view name);
