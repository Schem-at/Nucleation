#ifndef TickSimulation_D_HPP
#define TickSimulation_D_HPP
...
public:
   ...
   * applied.
   */
  inline static diplomat::result<std::unique_ptr<TickSimulation>, NucleationError> from_snbt(std::string_view snbt, TickSettleMode settle, int32_t origin_x, int32_t origin_y, int32_t origin_z, std::string_view extra_states);
   ...
   */
  inline diplomat::result<std::monostate, NucleationError> place_block(int32_t x, int32_t y, int32_t z, std::string_view state);
   ...
   */
  inline static std::string gametest_snbt(const Schematic& schematic);
  template<typename W>
   ...
   */
  inline diplomat::result<std::string, NucleationError> animation_timeline_json(uint32_t start_tick, uint32_t end_tick, float tick_ms) const;
  template<typename W>
  inline diplomat::result<std::monostate, NucleationError> animation_timeline_json_write(uint32_t start_tick, uint32_t end_tick, float tick_ms, W& writeable_output) const;
   ...
   * end_tick` is empty or outside the recorded span.
   */
  inline diplomat::result<std::string, NucleationError> selection_schematic_b64(uint32_t start_tick, uint32_t end_tick) const;
  template<typename W>
  inline diplomat::result<std::monostate, NucleationError> selection_schematic_b64_write(uint32_t start_tick, uint32_t end_tick, W& writeable_output) const;
   ...
   */
  inline static diplomat::result<std::string, NucleationError> machine_graph_batch_json(int32_t bx, int32_t by, int32_t bz, int32_t travel, int32_t x_off, std::string_view palette, diplomat::span<const uint16_t> cells, uint16_t air_index);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> machine_graph_batch_json_write(int32_t bx, int32_t by, int32_t bz, int32_t travel, int32_t x_off, std::string_view palette, diplomat::span<const uint16_t> cells, uint16_t air_index, W& writeable_output);

    inline const diplomat::capi::TickSimulation* AsFFI() const;
    inline diplomat::capi::TickSimulation* AsFFI();
    inline static const TickSimulation* FromFFI(const diplomat::capi::TickSimulation* ptr);
    inline static TickSimulation* FromFFI(diplomat::capi::TickSimulation* ptr);
    inline static void operator delete(void* ptr);
private:
    TickSimulation() = delete;
    TickSimulation(const TickSimulation&) = delete;
    TickSimulation(TickSimulation&&) noexcept = delete;
    TickSimulation operator=(const TickSimulation&) = delete;
    TickSimulation operator=(TickSimulation&&) noexcept = delete;
    static void operator delete[](void*, size_t) = delete;
};


#endif // TickSimulation_D_HPP
