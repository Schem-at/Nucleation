...
namespace capi {
    ...
    Voxelizer_shape_from_glb_result Voxelizer_shape_from_glb(diplomat::capi::DiplomatU8View data, float target_size);
    ...
    Voxelizer_shape_from_obj_result Voxelizer_shape_from_obj(diplomat::capi::DiplomatStringView text, float target_size);
    ...
    Voxelizer_schematic_from_glb_textured_result Voxelizer_schematic_from_glb_textured(diplomat::capi::DiplomatU8View data, float target_size, const diplomat::capi::Palette* palette, diplomat::capi::DiplomatStringView name);
...
inline diplomat::result<std::unique_ptr<Shape>, NucleationError> Voxelizer::shape_from_glb(diplomat::span<const uint8_t> data, float target_size) {
...
inline diplomat::result<std::unique_ptr<Shape>, NucleationError> Voxelizer::shape_from_obj(std::string_view text, float target_size) {
    auto result = diplomat::capi::Voxelizer_shape_from_obj({text.data(), text.size()},
        target_size);
    return result.is_ok ? diplomat::result<std::unique_ptr<Shape>, NucleationError>(diplomat::Ok<std::unique_ptr<Shape>>(std::unique_ptr<Shape>(Shape::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<Shape>, NucleationError>(diplomat::Err<NucleationError>(NucleationError::FromFFI(result.err)));
}

inline diplomat::result<std::unique_ptr<Schematic>, NucleationError> Voxelizer::schematic_from_glb_textured(diplomat::span<const uint8_t> data, float target_size, const Palette& palette, std::string_view name) {
