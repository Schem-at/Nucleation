...
namespace capi {
    ...
    Palette_ramp_ids_json_result Palette_ramp_ids_json(const diplomat::capi::Palette* self, uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps, diplomat::capi::DiplomatWrite* write);
    ...
    typedef struct Palette_closest_block_dithered_result {union { diplomat::capi::NucleationError err;}; bool is_ok;} Palette_closest_block_dithered_result;
    Palette_closest_block_dithered_result Palette_closest_block_dithered(const diplomat::capi::Palette* self, uint8_t r, uint8_t g, uint8_t b, int32_t x, int32_t y, int32_t z, diplomat::capi::DiplomatWrite* write);
...
inline std::unique_ptr<Palette> Palette::sorted_by_lightness() const {
    auto result = diplomat::capi::Palette_sorted_by_lightness(this->AsFFI());
    return std::unique_ptr<Palette>(Palette::FromFFI(result));
}

inline diplomat::result<std::string, NucleationError> Palette::ramp_ids_json(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps) const {
    std::string output;
    diplomat::capi::DiplomatWrite write = diplomat::WriteFromString(output);
    auto result = diplomat::capi::Palette_ramp_ids_json(this->AsFFI(),
        r1,
        g1,
        b1,
        r2,
...
template<typename W>
inline diplomat::result<std::monostate, NucleationError> Palette::ramp_ids_json_write(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps, W& writeable) const {
...
inline diplomat::result<std::string, NucleationError> Palette::gradient_ids_json(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps) const {
    std::string output;
    diplomat::capi::DiplomatWrite write = diplomat::WriteFromString(output);
    auto result = diplomat::capi::Palette_gradient_ids_json(this->AsFFI(),
        r1,
        g1,
        b1,
        r2,
...
template<typename W>
inline diplomat::result<std::monostate, NucleationError> Palette::gradient_ids_json_write(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps, W& writeable) const {
    diplomat::capi::DiplomatWrite write = diplomat::WriteTrait<W>::Construct(writeable);
    auto result = diplomat::capi::Palette_gradient_ids_json(this->AsFFI(),
        r1,
        g1,
...
inline diplomat::result<std::string, NucleationError> Palette::closest_block_dithered(uint8_t r, uint8_t g, uint8_t b, int32_t x, int32_t y, int32_t z) const {
    std::string output;
    diplomat::capi::DiplomatWrite write = diplomat::WriteFromString(output);
    auto result = diplomat::capi::Palette_closest_block_dithered(this->AsFFI(),
        r,
        g,
        b,
        x,
...
template<typename W>
inline diplomat::result<std::monostate, NucleationError> Palette::closest_block_dithered_write(uint8_t r, uint8_t g, uint8_t b, int32_t x, int32_t y, int32_t z, W& writeable) const {
    diplomat::capi::DiplomatWrite write = diplomat::WriteTrait<W>::Construct(writeable);
    auto result = diplomat::capi::Palette_closest_block_dithered(this->AsFFI(),
        r,
        g,
