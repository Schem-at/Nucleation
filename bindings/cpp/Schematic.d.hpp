...
public:
   ...
   */
  inline diplomat::result<int32_t, NucleationError> set_blocks_simulated(diplomat::span<const int32_t> positions, std::string_view block_name);
   ...
   */
  inline diplomat::result<int32_t, NucleationError> set_blocks_simulated_full_world(diplomat::span<const int32_t> positions, std::string_view block_name);
   ...
   */
  inline diplomat::result<uint64_t, NucleationError> replace_blocks_json(std::string_view map_json);
   ...
   */
  inline diplomat::result<std::string, NucleationError> compile_io_contracts_json() const;
  template<typename W>
  inline diplomat::result<std::monostate, NucleationError> compile_io_contracts_json_write(W& writeable_output) const;
