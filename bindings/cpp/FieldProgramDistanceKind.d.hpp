#ifndef FieldProgramDistanceKind_D_HPP
#define FieldProgramDistanceKind_D_HPP
...
public:
    ...
    inline diplomat::capi::FieldProgramDistanceKind AsFFI() const;
    inline static FieldProgramDistanceKind FromFFI(diplomat::capi::FieldProgramDistanceKind c_enum);
private:
    Value value;
};


#endif // FieldProgramDistanceKind_D_HPP
