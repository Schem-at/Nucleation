...
public:
   ...
   */
  inline static diplomat::result<std::string, NucleationError> get_json(std::string_view id);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> get_json_write(std::string_view id, W& writeable_output);
   ...
   */
  inline static diplomat::result<std::string, NucleationError> by_color_json(uint8_t r, uint8_t g, uint8_t b, float max_distance);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> by_color_json_write(uint8_t r, uint8_t g, uint8_t b, float max_distance, W& writeable_output);
   ...
   */
  inline static diplomat::result<std::string, NucleationError> by_tag_json(std::string_view tag);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> by_tag_json_write(std::string_view tag, W& writeable_output);
   ...
   */
  inline static diplomat::result<std::string, NucleationError> by_kind_json(std::string_view kind);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> by_kind_json_write(std::string_view kind, W& writeable_output);
   ...
   * base ids.
   */
  inline static diplomat::result<std::string, NucleationError> variants_of_json(std::string_view base_id);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> variants_of_json_write(std::string_view base_id, W& writeable_output);
   ...
   */
  inline static diplomat::result<std::string, NucleationError> states_json(std::string_view id);
  template<typename W>
  inline static diplomat::result<std::monostate, NucleationError> states_json_write(std::string_view id, W& writeable_output);
  ...
  inline static size_t count();
    ...
    inline const diplomat::capi::Blocks* AsFFI() const;
    inline diplomat::capi::Blocks* AsFFI();
    inline static const Blocks* FromFFI(const diplomat::capi::Blocks* ptr);
    inline static Blocks* FromFFI(diplomat::capi::Blocks* ptr);
    inline static void operator delete(void* ptr);
private:
    Blocks() = delete;
    Blocks(const Blocks&) = delete;
    Blocks(Blocks&&) noexcept = delete;
    Blocks operator=(const Blocks&) = delete;
    Blocks operator=(Blocks&&) noexcept = delete;
