#ifndef FieldProgramUnaryOp_D_HPP
#define FieldProgramUnaryOp_D_HPP
...
public:
    ...
    inline diplomat::capi::FieldProgramUnaryOp AsFFI() const;
    inline static FieldProgramUnaryOp FromFFI(diplomat::capi::FieldProgramUnaryOp c_enum);
private:
    Value value;
};


#endif // FieldProgramUnaryOp_D_HPP
