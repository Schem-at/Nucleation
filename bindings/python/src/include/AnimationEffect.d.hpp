...
public:
   ...
   */
  inline nucleation::diplomat::result<std::monostate, nucleation::NucleationError> add_tween(std::string_view property_name, float start, float end, std::string_view easing_name);
