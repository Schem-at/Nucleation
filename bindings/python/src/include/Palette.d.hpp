...
public:
   ...
   */
  inline static std::unique_ptr<nucleation::Palette> wood();
   ...
   */
  inline std::unique_ptr<nucleation::Palette> dithered() const;
   ...
   */
  inline std::unique_ptr<nucleation::Palette> sorted_by_lightness() const;
   ...
   */
  inline nucleation::diplomat::result<std::string, nucleation::NucleationError> ramp_ids_json(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps) const;
  template<typename W>
  inline nucleation::diplomat::result<std::monostate, nucleation::NucleationError> ramp_ids_json_write(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps, W& writeable_output) const;
   ...
   */
  inline nucleation::diplomat::result<std::string, nucleation::NucleationError> gradient_ids_json(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps) const;
  template<typename W>
  inline nucleation::diplomat::result<std::monostate, nucleation::NucleationError> gradient_ids_json_write(uint8_t r1, uint8_t g1, uint8_t b1, uint8_t r2, uint8_t g2, uint8_t b2, uint32_t steps, W& writeable_output) const;
   ...
   */
  inline nucleation::diplomat::result<std::string, nucleation::NucleationError> gradient_ids_between_blocks_json(std::string_view start_block, std::string_view end_block, uint32_t steps) const;
  template<typename W>
  inline nucleation::diplomat::result<std::monostate, nucleation::NucleationError> gradient_ids_between_blocks_json_write(std::string_view start_block, std::string_view end_block, uint32_t steps, W& writeable_output) const;
