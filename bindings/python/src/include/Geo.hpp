...
namespace capi {
    ...
    Geo_heightmap_terrain_result Geo_heightmap_terrain(nucleation::diplomat::capi::DiplomatStringView heights_json, int32_t width, nucleation::diplomat::capi::DiplomatStringView surface_block, nucleation::diplomat::capi::DiplomatStringView subsurface_block, int32_t surface_depth, nucleation::diplomat::capi::DiplomatStringView name);
...
inline nucleation::diplomat::result<std::unique_ptr<nucleation::Schematic>, nucleation::NucleationError> nucleation::Geo::heightmap_terrain(std::string_view heights_json, int32_t width, std::string_view surface_block, std::string_view subsurface_block, int32_t surface_depth, std::string_view name) {
