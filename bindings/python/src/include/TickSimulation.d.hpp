...
public:
   ...
   * ceiling and not.
   */
  inline nucleation::diplomat::result<std::string, nucleation::NucleationError> read_probes(std::string_view positions_json) const;
  template<typename W>
  inline nucleation::diplomat::result<std::monostate, nucleation::NucleationError> read_probes_write(std::string_view positions_json, W& writeable_output) const;
   ...
   */
  inline uint32_t bake_to(nucleation::Schematic& schematic) const;
