#ifndef NUCLEATION_DistanceField_D_HPP
#define NUCLEATION_DistanceField_D_HPP
...
namespace capi { struct DistanceField; }
class DistanceField;
...
public:
   ...
   */
  inline static std::unique_ptr<nucleation::DistanceField> from_schematic(const nucleation::Schematic& schematic);
  ...
  inline void normal_json_write(int32_t x, int32_t y, int32_t z, W& writeable_output) const;
    ...
    inline const nucleation::capi::DistanceField* AsFFI() const;
    inline nucleation::capi::DistanceField* AsFFI();
    inline static const nucleation::DistanceField* FromFFI(const nucleation::capi::DistanceField* ptr);
    inline static nucleation::DistanceField* FromFFI(nucleation::capi::DistanceField* ptr);
    inline static void operator delete(void* ptr);
private:
    DistanceField() = delete;
    DistanceField(const nucleation::DistanceField&) = delete;
    DistanceField(nucleation::DistanceField&&) noexcept = delete;
    DistanceField operator=(const nucleation::DistanceField&) = delete;
    DistanceField operator=(nucleation::DistanceField&&) noexcept = delete;
    static void operator delete[](void*, size_t) = delete;
};

} // namespace
#endif // NUCLEATION_DistanceField_D_HPP
