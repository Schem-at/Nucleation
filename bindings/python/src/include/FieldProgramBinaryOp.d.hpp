#ifndef NUCLEATION_FieldProgramBinaryOp_D_HPP
#define NUCLEATION_FieldProgramBinaryOp_D_HPP
...
public:
    ...
    inline nucleation::capi::FieldProgramBinaryOp AsFFI() const;
    inline static nucleation::FieldProgramBinaryOp FromFFI(nucleation::capi::FieldProgramBinaryOp c_enum);
private:
    Value value;
};

} // namespace
#endif // NUCLEATION_FieldProgramBinaryOp_D_HPP
