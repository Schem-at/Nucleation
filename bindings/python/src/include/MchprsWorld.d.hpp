#ifndef NUCLEATION_MchprsWorld_D_HPP
#define NUCLEATION_MchprsWorld_D_HPP
...
public:
   ...
   */
  inline static nucleation::diplomat::result<std::unique_ptr<nucleation::MchprsWorld>, nucleation::NucleationError> create(const nucleation::Schematic& schematic);

  /**
   * Create a simulation world with explicit options.
   */
  inline static nucleation::diplomat::result<std::unique_ptr<nucleation::MchprsWorld>, nucleation::NucleationError> create_with_options(const nucleation::Schematic& schematic, bool optimize, bool io_only);

  /**
   * Create a simulation world with custom IO positions
   * (`custom_io_positions` is flat `[x,y,z, x,y,z, ...]`).
   */
  inline static nucleation::diplomat::result<std::unique_ptr<nucleation::MchprsWorld>, nucleation::NucleationError> create_with_custom_io(const nucleation::Schematic& schematic, bool optimize, bool io_only, nucleation::diplomat::span<const int32_t> custom_io_positions);
   ...
   * a new `Schematic`.
   */
  inline static nucleation::diplomat::result<std::unique_ptr<nucleation::Schematic>, nucleation::NucleationError> simulate_use_block(const nucleation::Schematic& schematic, uint32_t ticks, nucleation::diplomat::span<const int32_t> events_xyz);
   ...
   */
  inline std::unique_ptr<nucleation::Schematic> get_schematic() const;
   ...
   */
  inline nucleation::diplomat::result<std::unique_ptr<nucleation::RedstoneGraph>, nucleation::NucleationError> export_graph() const;

  /**
   * Extract the structural (pre-fold, as-built) redstone logic graph.
   */
  inline nucleation::diplomat::result<std::unique_ptr<nucleation::RedstoneGraph>, nucleation::NucleationError> export_graph_structural() const;

    inline const nucleation::capi::MchprsWorld* AsFFI() const;
    inline nucleation::capi::MchprsWorld* AsFFI();
    inline static const nucleation::MchprsWorld* FromFFI(const nucleation::capi::MchprsWorld* ptr);
    inline static nucleation::MchprsWorld* FromFFI(nucleation::capi::MchprsWorld* ptr);
    inline static void operator delete(void* ptr);
private:
    MchprsWorld() = delete;
    MchprsWorld(const nucleation::MchprsWorld&) = delete;
    MchprsWorld(nucleation::MchprsWorld&&) noexcept = delete;
    MchprsWorld operator=(const nucleation::MchprsWorld&) = delete;
    MchprsWorld operator=(nucleation::MchprsWorld&&) noexcept = delete;
    static void operator delete[](void*, size_t) = delete;
};

} // namespace
#endif // NUCLEATION_MchprsWorld_D_HPP
