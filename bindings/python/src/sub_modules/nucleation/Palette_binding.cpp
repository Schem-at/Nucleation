...
void add_Palette_binding(nb::module_ mod) {
    ...
    opaque
        ...
        .def("for_material", std::move(maybe_op_unwrap(&nucleation::Palette::for_material)), "translucent"_a)
        .def_static("from_block_ids", std::move(maybe_op_unwrap(&nucleation::Palette::from_block_ids)), "ids_json"_a)
        .def("gradient_ids_between_blocks_json", &nucleation::Palette::gradient_ids_between_blocks_json, "start_block"_a, "end_block"_a, "steps"_a)
        ...
        .def_static("materials", std::move(maybe_op_unwrap(&nucleation::Palette::materials)))
