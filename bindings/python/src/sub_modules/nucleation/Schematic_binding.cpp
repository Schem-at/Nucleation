...
void add_Schematic_binding(nb::module_ mod) {
    ...
    opaque
        ...
        .def("apply_transform_plan_json", &nucleation::Schematic::apply_transform_plan_json, "plan_json"_a)
        ...
        .def("canonicalize_json", &nucleation::Schematic::canonicalize_json)
        .def("cell_contract_json", &nucleation::Schematic::cell_contract_json)
        .def("clear_contents", &nucleation::Schematic::clear_contents)
        .def("clear_provenance", &nucleation::Schematic::clear_provenance)
        .def("clear_transformation_history", &nucleation::Schematic::clear_transformation_history)
        ...
        .def("count_blocks_json", &nucleation::Schematic::count_blocks_json)
        ...
        .def_static("from_data_bounded", std::move(maybe_op_unwrap(&nucleation::Schematic::from_data_bounded)), "data"_a, "limits_json"_a)
        ...
        .def("get_region_non_air_blocks_json", &nucleation::Schematic::get_region_non_air_blocks_json, "region_name"_a)
        .def("has_region", &nucleation::Schematic::has_region, "region_name"_a)
        .def("inspect_registry_safe_json", &nucleation::Schematic::inspect_registry_safe_json)
        .def("inspect_transform_plan_json", &nucleation::Schematic::inspect_transform_plan_json, "plan_json"_a)
        ...
        .def("non_air_blocks_packed_b64", &nucleation::Schematic::non_air_blocks_packed_b64)
        ...
        .def("provenance_json", &nucleation::Schematic::provenance_json)
        .def("region_block_indices", &nucleation::Schematic::region_block_indices, "region_name"_a, "start"_a, "count"_a)
        ...
        .def("render_regions_json", &nucleation::Schematic::render_regions_json)
        .def("replace_blocks_json", &nucleation::Schematic::replace_blocks_json, "map_json"_a)
        .def("resolve_cell_contract_json", &nucleation::Schematic::resolve_cell_contract_json)
        ...
        .def("set_provenance_json", &nucleation::Schematic::set_provenance_json, "json"_a)
        ...
        .def("split_connected_attach_nearby", std::move(maybe_op_unwrap(&nucleation::Schematic::split_connected_attach_nearby)), "min_standalone_blocks"_a, "max_air_gap"_a)
        ...
        .def("transformation_history_json", &nucleation::Schematic::transformation_history_json)
