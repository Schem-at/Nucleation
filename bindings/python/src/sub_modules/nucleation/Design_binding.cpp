...
void add_Design_binding(nb::module_ mod) {
    ...
    opaque
        ...
        .def("bus_blocks_json", &nucleation::Design::bus_blocks_json, "name"_a)
        .def("bus_skew", &nucleation::Design::bus_skew, "name"_a)
        .def("bus_state", &nucleation::Design::bus_state, "name"_a)
        .def("bus_width_map", &nucleation::Design::bus_width_map, "name"_a)
        .def("changed_layers_since", &nucleation::Design::changed_layers_since, "rev"_a)
        ...
        .def("instance_blocks_json", &nucleation::Design::instance_blocks_json, "name"_a)
        .def("instance_ports", &nucleation::Design::instance_ports)
        .def("layer_revision", &nucleation::Design::layer_revision)
        ...
        .def("remove_gate", &nucleation::Design::remove_gate, "bus"_a, "index"_a)
        .def("remove_instance", &nucleation::Design::remove_instance, "name"_a)
        .def("remove_port", &nucleation::Design::remove_port, "name"_a, "force"_a)
        ...
        .def("route_bus_adapted", &nucleation::Design::route_bus_adapted, "name"_a, "driver"_a, "sinks_csv"_a, "gates_json"_a, "style_json"_a, "align"_a, "shift"_a, "truncate"_a)
