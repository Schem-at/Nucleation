...
void add_Curve3D_binding(nb::module_);
...
void add_WsPartitionHints_binding(nb::module_);
void add_WsProfile_binding(nb::module_);
void add_WsRunResult_binding(nb::module_);
void add_WsSegmentJob_binding(nb::module_);
...
void add_TickSettleMode_binding(nb::module_);
void add_MeshPhase_binding(nb::module_);
void add_FieldProgramBinaryOp_binding(nb::module_);
void add_FieldProgramDistanceKind_binding(nb::module_);
void add_FieldProgramUnaryOp_binding(nb::module_);
void add_FieldProgramValueType_binding(nb::module_);
...
NB_MODULE(nucleation, mod)
{
    ...
    add_WsPartitionHints_binding(mod);
    add_WsProfile_binding(mod);
    add_WsRunResult_binding(mod);
    add_WsSegmentJob_binding(mod);
    add_WorldChunkView_binding(mod);
    add_WorldSink_binding(mod);
    add_WorldStream_binding(mod);
    add_InterpolationSpace_binding(mod);
    add_TickSettleMode_binding(mod);
    add_MeshPhase_binding(mod);
    add_FieldProgramBinaryOp_binding(mod);
    add_FieldProgramDistanceKind_binding(mod);
    add_FieldProgramUnaryOp_binding(mod);
    add_FieldProgramValueType_binding(mod);
