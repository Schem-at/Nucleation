...
typedef enum TickSettleMode { TickSettleMode_Placement = 0, TickSettleMode_Quiet = 1, TickSettleMode_InWorld = 2, } TickSettleMode;
...
typedef enum FieldProgramBinaryOp { FieldProgramBinaryOp_Add = 0, FieldProgramBinaryOp_Sub = 1, FieldProgramBinaryOp_Mul = 2, FieldProgramBinaryOp_Div = 3, FieldProgramBinaryOp_Min = 4, FieldProgramBinaryOp_Max = 5, FieldProgramBinaryOp_Pow = 6, FieldProgramBinaryOp_Atan2 = 7, FieldProgramBinaryOp_Lt = 8, FieldProgramBinaryOp_Le = 9, FieldProgramBinaryOp_Gt = 10, FieldProgramBinaryOp_Ge = 11, FieldProgramBinaryOp_Eq = 12, FieldProgramBinaryOp_Dot = 13, FieldProgramBinaryOp_Cross = 14, FieldProgramBinaryOp_Scale = 15, } FieldProgramBinaryOp;
typedef enum FieldProgramDistanceKind { FieldProgramDistanceKind_Exact = 0, FieldProgramDistanceKind_LowerBound = 1, FieldProgramDistanceKind_Estimate = 2, FieldProgramDistanceKind_Implicit = 3, } FieldProgramDistanceKind;
typedef enum FieldProgramUnaryOp { FieldProgramUnaryOp_Neg = 0, FieldProgramUnaryOp_Abs = 1, FieldProgramUnaryOp_Sqrt = 2, FieldProgramUnaryOp_Log = 3, FieldProgramUnaryOp_Sin = 4, FieldProgramUnaryOp_Cos = 5, FieldProgramUnaryOp_Acos = 6, FieldProgramUnaryOp_VecX = 7, FieldProgramUnaryOp_VecY = 8, FieldProgramUnaryOp_VecZ = 9, FieldProgramUnaryOp_Length = 10, FieldProgramUnaryOp_Normalize = 11, } FieldProgramUnaryOp;
typedef enum FieldProgramValueType { FieldProgramValueType_Scalar = 0, FieldProgramValueType_Vec3 = 1, FieldProgramValueType_Bool = 2, } FieldProgramValueType;
typedef enum SdfAxis { SdfAxis_X = 0, SdfAxis_Y = 1, SdfAxis_Z = 2, } SdfAxis;
typedef enum SdfCellMode { SdfCellMode_F1 = 0, SdfCellMode_F2 = 1, SdfCellMode_F2MinusF1 = 2, SdfCellMode_CellValue = 3, } SdfCellMode;
typedef enum NucleationError { NucleationError_NullArgument = 0, NucleationError_InvalidArgument = 1, NucleationError_Parse = 2, NucleationError_Serialize = 3, NucleationError_Io = 4, NucleationError_Lock = 5, NucleationError_Store = 6, NucleationError_Mesh = 7, NucleationError_Render = 8, NucleationError_Simulation = 9, NucleationError_AlreadyConsumed = 10, NucleationError_NotFound = 11, NucleationError_Generation = 12, } NucleationError;
typedef enum GeneratedChunkCoverage { GeneratedChunkCoverage_Complete = 0, GeneratedChunkCoverage_Partial = 1, GeneratedChunkCoverage_Outside = 2, } GeneratedChunkCoverage;
typedef enum GeneratedChunkOverlayMode { GeneratedChunkOverlayMode_Replace = 0, GeneratedChunkOverlayMode_KeepExisting = 1, } GeneratedChunkOverlayMode;
...
typedef struct FieldRange { float min; float max; } FieldRange;
typedef struct DiplomatFieldRangeView { const FieldRange* data; size_t len; } DiplomatFieldRangeView;
typedef struct SdfBounds { float min_x; float min_y; float min_z; float max_x; float max_y; float max_z; } SdfBounds;
typedef struct DiplomatSdfBoundsView { const SdfBounds* data; size_t len; } DiplomatSdfBoundsView;
typedef struct SdfNormal { float x; float y; float z; } SdfNormal;
typedef struct DiplomatSdfNormalView { const SdfNormal* data; size_t len; } DiplomatSdfNormalView;
...
typedef struct Field3 Field3;
typedef struct Geo Geo;
typedef struct Hdl Hdl;
typedef struct TickSimulation TickSimulation;
...
typedef struct SchematicSplitResult SchematicSplitResult;
typedef struct SchematicBuilder SchematicBuilder;
typedef struct Scripting Scripting;
typedef struct FieldProgram FieldProgram;
typedef struct FieldProgramBuilder FieldProgramBuilder;
typedef struct Sdf Sdf;
typedef struct CellExecutor CellExecutor;
...
typedef struct CellularSdfConfig CellularSdfConfig;
typedef struct GeneratedChunk GeneratedChunk;
typedef struct GeneratedWorldStream GeneratedWorldStream;
typedef struct WorldGenerator WorldGenerator;
typedef struct WsPartitionHints WsPartitionHints;
typedef struct WsProfile WsProfile;
typedef struct WsRunResult WsRunResult;
...
BuildAnimation_from_schematic_result BuildAnimation_from_schematic(Schematic* schematic);
void BuildAnimation_animate_all(BuildAnimation* self, AnimationEffect* effect);
...
BuildAnimation_stamp_region_result BuildAnimation_stamp_region(BuildAnimation* self, Schematic* source, DiplomatStringView region, int32_t x, int32_t y, int32_t z, DiplomatStringView exclusions, float duration_ms);
...
BuildAnimation_to_animated_glb_b64_result BuildAnimation_to_animated_glb_b64(BuildAnimation* self, ResourcePack* pack, float fps, DiplomatWrite* write);
...
BuildAnimation_to_schem_b64_result BuildAnimation_to_schem_b64(BuildAnimation* self, DiplomatWrite* write);
...
BuildAnimation_to_litematic_b64_result BuildAnimation_to_litematic_b64(BuildAnimation* self, DiplomatWrite* write);
...
BuildAnimation_frame_json_result BuildAnimation_frame_json(BuildAnimation* self, float time_ms, DiplomatWrite* write);
...
BuildAnimation_render_video_with_pack_result BuildAnimation_render_video_with_pack(BuildAnimation* self, ResourcePack* pack, RenderConfig* config, VideoConfig* video, DiplomatStringView path, float hold_ms);
...
BuildAnimation_render_video_result BuildAnimation_render_video(BuildAnimation* self, DiplomatU8View pack_zip, RenderConfig* config, VideoConfig* video, DiplomatStringView path, float hold_ms);
...
Brush_field_sdf_result Brush_field_sdf(Sdf* field, DiplomatF32View stops, DiplomatU8View colors, float lo, float hi, InterpolationSpace space);
typedef struct Brush_field3_result { union { Brush* ok; NucleationError err; }; bool is_ok; } Brush_field3_result;
Brush_field3_result Brush_field3(Field3* field, DiplomatF32View stops, DiplomatU8View colors, float lo, float hi, InterpolationSpace space);
...
Palette_gradient_ids_between_blocks_json_result Palette_gradient_ids_between_blocks_json(Palette* self, DiplomatStringView start_block, DiplomatStringView end_block, uint32_t steps, DiplomatWrite* write);
...
Design_for_schematic_result Design_for_schematic(DiplomatStringView name, Schematic* base);
typedef struct Design_add_cell_result { union { NucleationError err; }; bool is_ok; } Design_add_cell_result;
Design_add_cell_result Design_add_cell(Design* self, DiplomatStringView name, Schematic* cell, DiplomatWrite* write);
...
Design_to_schem_b64_result Design_to_schem_b64(Design* self, DiplomatWrite* write);
...
Design_flatten_composite_result Design_flatten_composite(Design* self);
typedef struct Design_instance_ports_result { union { NucleationError err; }; bool is_ok; } Design_instance_ports_result;
Design_instance_ports_result Design_instance_ports(Design* self, DiplomatWrite* write);
...
void Design_port_modes(Design* self, DiplomatWrite* write);
typedef struct Design_plan_port_promotion_result { union { NucleationError err; }; bool is_ok; } Design_plan_port_promotion_result;
Design_plan_port_promotion_result Design_plan_port_promotion(Design* self, DiplomatStringView instance, DiplomatStringView port, DiplomatWrite* write);
typedef struct Design_resolve_port_result { union { NucleationError err; }; bool is_ok; } Design_resolve_port_result;
Design_resolve_port_result Design_resolve_port(Design* self, DiplomatStringView name, DiplomatWrite* write);
...
Design_bus_width_map_result Design_bus_width_map(Design* self, DiplomatStringView name, DiplomatWrite* write);
uint64_t Design_layer_revision(Design* self);
void Design_changed_layers_since(Design* self, uint64_t rev, DiplomatWrite* write);
...
Design_bus_skew_result Design_bus_skew(Design* self, DiplomatStringView name, DiplomatWrite* write);
typedef struct Design_bus_state_result { union { NucleationError err; }; bool is_ok; } Design_bus_state_result;
Design_bus_state_result Design_bus_state(Design* self, DiplomatStringView name, DiplomatWrite* write);
typedef struct Design_bus_blocks_json_result { union { NucleationError err; }; bool is_ok; } Design_bus_blocks_json_result;
Design_bus_blocks_json_result Design_bus_blocks_json(Design* self, DiplomatStringView name, DiplomatWrite* write);
...
Design_instance_blocks_json_result Design_instance_blocks_json(Design* self, DiplomatStringView name, DiplomatWrite* write);
...
Design_save_nucm_result Design_save_nucm(Design* self, DiplomatStringView path);
...
Design_to_litematic_b64_result Design_to_litematic_b64(Design* self, DiplomatWrite* write);
...
Design_export_litematic_result Design_export_litematic(Design* self, DiplomatStringView path);
...
Field3_to_json_result Field3_to_json(Field3* self, DiplomatWrite* write);
...
uint32_t TickSimulation_tick_count(TickSimulation* self);
bool TickSimulation_is_quiescent(TickSimulation* self);
...
void TickSimulation_gametest_snbt(Schematic* schematic, DiplomatWrite* write);
void TickSimulation_block_entity_audit_json(Schematic* schematic, DiplomatWrite* write);
...
void TickSimulation_timeline_activity_json(TickSimulation* self, DiplomatWrite* write);
void TickSimulation_timeline_cycles_json(TickSimulation* self, DiplomatWrite* write);
...
TickSimulation_animation_timeline_json_result TickSimulation_animation_timeline_json(TickSimulation* self, uint32_t start_tick, uint32_t end_tick, float tick_ms, DiplomatWrite* write);
...
TickSimulation_selection_schematic_b64_result TickSimulation_selection_schematic_b64(TickSimulation* self, uint32_t start_tick, uint32_t end_tick, DiplomatWrite* write);
uint32_t TickSimulation_updates_count(TickSimulation* self);
void TickSimulation_updates_json(TickSimulation* self, DiplomatWrite* write);
...
int32_t TickSimulation_non_air_min_x(TickSimulation* self);
int32_t TickSimulation_non_air_max_x(TickSimulation* self);
uint32_t TickSimulation_changes_count(TickSimulation* self);
void TickSimulation_world_snapshot_json(TickSimulation* self, DiplomatWrite* write);
void TickSimulation_machine_graph_json(TickSimulation* self, DiplomatWrite* write);
...
Renderer_render_to_file_with_pack_result Renderer_render_to_file_with_pack(Schematic* schematic, ResourcePack* pack, RenderConfig* config, DiplomatStringView path);
...
Renderer_render_pixels_b64_with_pack_result Renderer_render_pixels_b64_with_pack(Schematic* schematic, ResourcePack* pack, RenderConfig* config, DiplomatWrite* write);
...
Renderer_render_png_b64_with_pack_result Renderer_render_png_b64_with_pack(Schematic* schematic, ResourcePack* pack, RenderConfig* config, DiplomatWrite* write);
...
Routing_lvs_result Routing_lvs(Schematic* schematic, DiplomatStringView intent_json, DiplomatWrite* write);
typedef struct Routing_drc_result { union { NucleationError err; }; bool is_ok; } Routing_drc_result;
Routing_drc_result Routing_drc(Schematic* schematic, bool check_decay, DiplomatWrite* write);
typedef struct Routing_sta_result { union { NucleationError err; }; bool is_ok; } Routing_sta_result;
Routing_sta_result Routing_sta(Schematic* schematic, DiplomatStringView netlist_json, DiplomatWrite* write);
...
Schematic_inspect_transform_plan_json_result Schematic_inspect_transform_plan_json(Schematic* self, DiplomatStringView plan_json, DiplomatWrite* write);
...
void Schematic_inspect_registry_safe_json(Schematic* self, DiplomatWrite* write);
SchematicSplitResult* Schematic_split_connected_attach_nearby(Schematic* self, uint32_t min_standalone_blocks, uint32_t max_air_gap);
...
Schematic_save_result Schematic_save(Schematic* self, DiplomatStringView path);
...
Schematic_get_region_non_air_blocks_json_result Schematic_get_region_non_air_blocks_json(Schematic* self, DiplomatStringView region_name, DiplomatWrite* write);
void Schematic_get_non_air_blocks_json(Schematic* self, DiplomatWrite* write);
void Schematic_count_blocks_json(Schematic* self, DiplomatWrite* write);
...
void Schematic_non_air_blocks_packed_b64(Schematic* self, DiplomatWrite* write);
...
Schematic_get_chunk_non_air_blocks_json_result Schematic_get_chunk_non_air_blocks_json(Schematic* self, int32_t offset_x, int32_t offset_y, int32_t offset_z, int32_t width, int32_t height, int32_t length, DiplomatWrite* write);
void Schematic_render_regions_json(Schematic* self, DiplomatWrite* write);
...
Schematic_provenance_json_result Schematic_provenance_json(Schematic* self, DiplomatWrite* write);
...
void Schematic_transformation_history_json(Schematic* self, DiplomatWrite* write);
...
Schematic_cell_contract_json_result Schematic_cell_contract_json(Schematic* self, DiplomatWrite* write);
...
Schematic_resolve_cell_contract_json_result Schematic_resolve_cell_contract_json(Schematic* self, DiplomatWrite* write);
...
Schematic_compile_io_contracts_json_result Schematic_compile_io_contracts_json(Schematic* self, DiplomatWrite* write);
...
uint32_t SchematicSplitResult_len(SchematicSplitResult* self);
...
SchematicSplitResult_piece_result SchematicSplitResult_piece(SchematicSplitResult* self, uint32_t index);
...
FieldProgram_to_json_result FieldProgram_to_json(FieldProgram* self, DiplomatWrite* write);
float FieldProgram_eval_at(FieldProgram* self, float x, float y, float z);
...
FieldProgram_gradient_result FieldProgram_gradient(FieldProgram* self, float x, float y, float z, float epsilon);
SdfBounds FieldProgram_bounds(FieldProgram* self);
FieldProgramDistanceKind FieldProgram_distance_kind(FieldProgram* self);
void FieldProgram_destroy(FieldProgram* self);
FieldProgramBuilder* FieldProgramBuilder_create();
...
Sdf_to_json_result Sdf_to_json(Sdf* self, DiplomatWrite* write);
Sdf* Sdf_from_program(FieldProgram* program);
...
CellExecutor_for_schematic_result CellExecutor_for_schematic(Schematic* schematic);
typedef struct CellExecutor_set_input_result { union { NucleationError err; }; bool is_ok; } CellExecutor_set_input_result;
CellExecutor_set_input_result CellExecutor_set_input(CellExecutor* self, DiplomatStringView name, Value* value);
...
VoxelModel_plan_json_result VoxelModel_plan_json(VoxelModel* self, DiplomatStringView options_json, DiplomatWrite* write);
...
VoxelModel_to_schematic_result VoxelModel_to_schematic(VoxelModel* self, DiplomatStringView options_json, Palette* palette, DiplomatStringView name);
...
GeneratedChunk_cx_result GeneratedChunk_cx(GeneratedChunk* self);
typedef struct GeneratedChunk_cz_result { union { int32_t ok; NucleationError err; }; bool is_ok; } GeneratedChunk_cz_result;
GeneratedChunk_cz_result GeneratedChunk_cz(GeneratedChunk* self);
...
GeneratedChunk_coverage_result GeneratedChunk_coverage(GeneratedChunk* self);
typedef struct GeneratedChunk_source_id_result { union { NucleationError err; }; bool is_ok; } GeneratedChunk_source_id_result;
GeneratedChunk_source_id_result GeneratedChunk_source_id(GeneratedChunk* self, DiplomatWrite* write);
typedef struct GeneratedChunk_version_result { union { NucleationError err; }; bool is_ok; } GeneratedChunk_version_result;
GeneratedChunk_version_result GeneratedChunk_version(GeneratedChunk* self, DiplomatWrite* write);
...
uint64_t GeneratedWorldStream_remaining(GeneratedWorldStream* self);
...
WorldGenerator_sdf_result WorldGenerator_sdf(Sdf* volume, Brush* material, int32_t min_y, int32_t max_y, DiplomatStringView source_id, DiplomatStringView version);
...
WorldGenerator_cellular_sdf_result WorldGenerator_cellular_sdf(Sdf* volume, Brush* material, int32_t min_y, int32_t max_y, CellularSdfConfig* config, DiplomatStringView source_id, DiplomatStringView version);
...
WorldGenerator_add_layer_result WorldGenerator_add_layer(WorldGenerator* self, WorldGenerator* source, GeneratedChunkOverlayMode mode);
...
WorldGenerator_generate_result WorldGenerator_generate(WorldGenerator* self, int32_t cx, int32_t cz);
...
WorldGenerator_stream_result WorldGenerator_stream(WorldGenerator* self, int32_t min_cx, int32_t min_cz, int32_t max_cx, int32_t max_cz);
void WorldGenerator_destroy(WorldGenerator* self);
WsPartitionHints* WsPartitionHints_create();
...
uint32_t WsPartitionHints_len(WsPartitionHints* self);
...
int32_t WsProfile_band_min(WsProfile* self);
int32_t WsProfile_band_max(WsProfile* self);
uint32_t WsProfile_palette_len(WsProfile* self);
...
WsProfile_write_palette_json_result WsProfile_write_palette_json(WsProfile* self, DiplomatWrite* write);
...
WsRunResult_run_dir_result WsRunResult_run_dir(WsSegmentJob* job, WsPartitionHints* hints, WsProfile* profile, DiplomatStringView world_dir);
uint64_t WsRunResult_builds(WsRunResult* self);
uint64_t WsRunResult_tier_confident(WsRunResult* self);
uint64_t WsRunResult_tier_probable(WsRunResult* self);
uint64_t WsRunResult_tier_debris(WsRunResult* self);
uint64_t WsRunResult_cross_tile(WsRunResult* self);
uint64_t WsRunResult_largest_block_count(WsRunResult* self);
uint32_t WsRunResult_build_count(WsRunResult* self);
typedef struct WsRunResult_stable_id_hex_result { union { NucleationError err; }; bool is_ok; } WsRunResult_stable_id_hex_result;
WsRunResult_stable_id_hex_result WsRunResult_stable_id_hex(WsRunResult* self, uint32_t index, DiplomatWrite* write);
...
WsRunResult_fingerprint_hex_result WsRunResult_fingerprint_hex(WsRunResult* self, uint32_t index, DiplomatWrite* write);
typedef struct WsRunResult_tier_of_result { union { uint8_t ok; NucleationError err; }; bool is_ok; } WsRunResult_tier_of_result;
WsRunResult_tier_of_result WsRunResult_tier_of(WsRunResult* self, uint32_t index);
...
WsRunResult_block_count_of_result WsRunResult_block_count_of(WsRunResult* self, uint32_t index);
...
WsRunResult_bbox_min_of_result WsRunResult_bbox_min_of(WsRunResult* self, uint32_t index);
...
WsRunResult_bbox_max_of_result WsRunResult_bbox_max_of(WsRunResult* self, uint32_t index);
typedef struct WsRunResult_write_schem_to_result { union { NucleationError err; }; bool is_ok; } WsRunResult_write_schem_to_result;
WsRunResult_write_schem_to_result WsRunResult_write_schem_to(WsRunResult* self, uint32_t index, DiplomatStringView path);
