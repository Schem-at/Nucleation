...
Voxelizer_schematic_from_glb_textured_result Voxelizer_schematic_from_glb_textured(DiplomatU8View data, float target_size, float shell, const Palette* palette, DiplomatStringView name);
