...
class SchematicBuilder:
    ...
    def layer(self, rows: List[str]) -> "SchematicBuilder":
        """Append a single layer (list of row strings)."""
        ...

    def palette(self, mappings: List[Tuple[str, str]]) -> "SchematicBuilder":
        """Bulk-register palette characters."""
        ...
    ...
    def validate(self) -> None:
        """Run pre-build validation. Raises ``ValueError`` if malformed."""
        ...
