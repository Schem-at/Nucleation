...
[`crates/mc-tick/docs/history/entity-abuse-in-record-doors.md`](../../crates/mc-tick/docs/history/entity-abuse-in-record-doors.md).
...
- **Retraction is a drag and a correction.** The head drags entities toward the
  base — clipped against the retracting base's own 12/16 collision box — and
...
- **Sticky short pulses drop the block** — and only a block still travelling
