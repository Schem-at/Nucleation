...
illustrations=(
  ...
  docs/media/kineglyph/fast-generation.light.svg \
  docs/media/kineglyph/shapes-and-brushes.svg \
  docs/media/kineglyph/shapes-and-brushes.light.svg \
  docs/media/kineglyph/sdf-and-fields.svg \
  docs/media/kineglyph/sdf-and-fields.light.svg \
  docs/media/kineglyph/palettes-and-color.svg \
  docs/media/kineglyph/palettes-and-color.light.svg \
  docs/media/kineglyph/smart-simulation.svg \
  docs/media/kineglyph/smart-simulation.light.svg \
  docs/media/kineglyph/formats-and-io.svg \
  docs/media/kineglyph/formats-and-io.light.svg \
  docs/media/kineglyph/bindings-and-languages.svg \
  docs/media/kineglyph/bindings-and-languages.light.svg \
  docs/media/kineglyph/meshing-and-rendering.svg
  docs/media/kineglyph/meshing-and-rendering.light.svg
)

zip -j -X -q "$temporary" "${illustrations[@]}"

test "$(unzip -Z1 "$temporary" | wc -l | tr -d ' ')" = "16"
...
mv "$temporary" "$output"
echo "Collected 8 scenes in dark and light SVG variants in $output"
